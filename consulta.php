		...
		<div class="container" id="wrapper">
			...
			<section id="content" class="col-lg-7 col-md-8 col-sm-12">
				...
				<div class="content-bg">
					...
					<form action="php/asignar.php" method="post">
					<strong>Identificación</strong><input type="text" name="id">
					<input class="button red" type="submit" value="&#xf138; Buscar">
					</form>
					<form  action="#" method="post">
						 
						<strong>Nombre</strong><input type="text" name="nombre" value="<?php echo $fila['Nombre_Persona']; ?>" readonly>
						<strong>Género</strong><input type="text" name="genero" value="<?php echo $fila['Genero_Persona']; ?>" readonly>
